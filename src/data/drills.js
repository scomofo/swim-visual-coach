...
export const DRILLS = {
  ...
  chestPress: {
    ...
    tags: [
      ...
      { label: 'Press your buoy', cue: 'chest' },
    ],
    coach: 'A small forward weight shift lifts the hips more effectively than frantic kicking.',
    narration: 'Press your buoy. Press the chest gently and allow the hips to rise.',
  ...
  skating: {
    ...
    narration: 'Become long and narrow through the water. Keep the lead arm patient in the front quadrant.',
  ...
  sweetSpot: {
    ...
    tags: [
      ...
      { label: 'No effort', cue: 'chest' },
      { label: 'Balance check', cue: 'hips' },
    ],
    coach: 'The sweet spot is your home base. Whenever form slips, return here and rebuild.',
    narration: 'Settle into the sweet spot. Rest, but keep your balance.',
    next: 'Single Switch',
  },
  singleSwitch: {
    id: 'singleSwitch',
    ...
    tags: [
      ...
      { label: 'High elbow', cue: 'arm' },
      { label: 'Core rotation', cue: 'chest' },
    ],
    coach: 'The torso moves the swimmer. The hand enters quietly, anchors with a high elbow — never press water past the hip — and the body rotates around it.',
    narration: 'Switch once, anchor the hand, then wait. The core does the work.',
    next: 'Triple Switch',
  },
  tripleSwitch: {
    id: 'tripleSwitch',
    ...
    coach: 'Switch, balance, switch, balance. Anchor each hand and rotate the torso around it. Never press water past the hip.',
    narration: 'Three patient switches, each anchored. Then glide.',
    next: 'Two-Beat Kick',
  },
  twoBeatKick: {
    id: 'twoBeatKick',
    ...
    tags: [
      ...
      { label: 'Rotation, not propulsion', cue: 'chest' },
      { label: 'Quiet legs', cue: 'hips' },
    ],
    coach: 'Kick exactly as the hand spears forward — two kicks per full stroke cycle, nothing more. The kick turns the body; the body moves the swimmer.',
    narration: 'Spear, then kick. The leg answers the hand.',
    next: 'Rhythm Swim',
  },
  rhythm: {
    id: 'rhythm',
  ...
  spl: {
    ...
    tags: [
      ...
      { label: 'Front-quadrant swim', cue: 'arm' },
      { label: 'Fewer strokes', cue: 'arm' },
    ],
    coach: 'Count strokes as feedback, not judgment. Make it your single focal point: a spike means slow down and reset.',
    narration: 'Hold the lead arm in the front quadrant. Glide farther on fewer strokes.',
    next: 'Effortless 25',
  },
  effortless25: {
    id: 'effortless25',
    ...
    coach: 'Consistency is the goal. Keep the same calm stroke count across the length. If form or stroke count slips, stop and rest — never practice struggling.',
